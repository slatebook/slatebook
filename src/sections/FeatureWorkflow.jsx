      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 md:gap-8">
          {workflows.map((workflow, index) => (
            ...
            >
              <div className="relative bg-white rounded-2xl p-6 md:p-8 hover:bg-gray-50 transition-all duration-300 border border-gray-200 hover:border-black hover:shadow-xl h-full">
                {/* Step Number */}
                <div className={`inline-block mb-4 md:mb-6 px-4 py-2 rounded-full border border-black text-black font-bold text-sm md:text-base`}>
                  {workflow.step}
                </div>
                ...
                {/* Description */}
                <p className="text-sm md:text-base text-gray-700 mb-4 md:mb-6 leading-relaxed font-serif">
                ...
                {/* Mockup Placeholder */}
                <div className="mt-6 md:mt-8 aspect-video bg-gray-100 rounded-lg flex items-center justify-center border border-gray-200">
                  <div className="text-center">
                    <div className="w-16 h-16 md:w-20 md:h-20 mx-auto rounded-full bg-white border-2 border-black flex items-center justify-center mb-2">
